...
// Define the calculation type for proper typing
...
const DACalculatorPro = () => {
  ...
  const generatePDF = () => {
    ...
    // Enhanced table styling for jsPDF with autoTable plugin
    ...
    // Get the final Y position from autoTable or use a default
    const previousTableEndY = (doc as any).autoTable ? (doc as any).autoTable.previous.finalY : 150;
    let yPos = previousTableEndY + 20;
    ...
    // Add page numbers if internal method is available
                ...
                <div>
                  ...
                  <Alert className="mt-2 bg-blue-50 border-blue-200">
                    ...
                    <AlertDescription className="text-blue-700">
                      Latest official DA rate: 56% (January 2025)
                    </AlertDescription>
                  </Alert>
                </div>
